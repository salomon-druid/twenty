...
const NAME_FIELD_NAME = 'claimNumber';

export const SEARCH_FIELDS_FOR_CLAIM: FieldTypeAndNameMetadata[] = [
  { name: NAME_FIELD_NAME, type: FieldMetadataType.TEXT },
];

export class ClaimWorkspaceEntity extends BaseWorkspaceEntity {
  claimNumber: string;
  date: Date | null;
