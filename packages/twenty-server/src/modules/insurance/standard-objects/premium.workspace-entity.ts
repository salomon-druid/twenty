...
const NAME_FIELD_NAME = 'amount';

export const SEARCH_FIELDS_FOR_PREMIUM: FieldTypeAndNameMetadata[] = [
  { name: NAME_FIELD_NAME, type: FieldMetadataType.CURRENCY },
];

export class PremiumWorkspaceEntity extends BaseWorkspaceEntity {
